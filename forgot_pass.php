...
<div id="pageMiddle">
  ...
  <form id="forgotpassform" onsubmit="return false;">
    ...
    <input type="text" id="email" onfocus="_('status').innerHTML'';" maxlength="88">
        <br /><br />
