...
div#photo_showcase{float:right; background:url(style/photo_showcase_bg.png) no-repeat; width:136px; height:127px; margin:20px 30px 0px 0px; cursor:pointer;}
div#photo_showcase > img{width:136px; height:127px; margin:37px 0px 0px 9px;}
